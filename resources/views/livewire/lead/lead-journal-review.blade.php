<div class="space-y-6" wire:poll.visible.20s>
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-3">
        <input type="date" wire:model.live="logDate" class="rounded-lg border border-gray-300 px-3 py-2 text-sm">

        <select wire:model.live="teamId" class="rounded-lg border border-gray-300 px-3 py-2 text-sm">
        ...
        <select wire:model.live="memberId" class="rounded-lg border border-gray-300 px-3 py-2 text-sm">
        ...
        <select wire:model.live="taskId" class="rounded-lg border border-gray-300 px-3 py-2 text-sm lg:col-span-2">
