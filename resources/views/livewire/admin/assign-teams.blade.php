<div class="space-y-5">
    ...
    @if($showForm)
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                ...
                <div>
                    <label class="mb-1 block text-sm font-medium text-gray-700">Team Lead <span class="text-red-500">*</span></label>
            ...
            <div class="mt-5 flex items-center gap-3">
                ...
                <button wire:click="cancelForm"
                        class="rounded-lg border border-gray-300 bg-white px-5 py-2 text-sm font-semibold text-gray-600 transition hover:bg-gray-50">
                    Cancel
                </button>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 gap-4 xl:grid-cols-2" @if(!$showForm) wire:poll.visible.60s @endif>
        ...
        @empty
            <div class="xl:col-span-2 rounded-xl border border-gray-200 bg-white px-6 py-16 text-center shadow-sm">
